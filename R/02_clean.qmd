...
GO_results_np_vs_nn_24_data_frame <- as.data.frame(GO_results_np_vs_nn_24_filtered)

#Plot pp vs. nn timepoint 24
GO_results_pp_vs_nn_24_plot <- plot(barplot(GO_results_pp_vs_nn_24_filtered, 
                                           showCategory = 20,
                                           title = "GO",
                                           font.size = 5))

png("GO_results.png", res =250, width = 1000, height = 1300)
print(GO_results_pp_vs_nn_24_plot)
dev.off()

#png("GO_results_np_vs_nn_24_plot.png", res =250, width = 1000, height = 1300)
#print(GO_results_np_vs_nn_24_plot)
#dev.off()
```
